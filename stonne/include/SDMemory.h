...
public:
    ...
    Tile* current_tile;
    bool finished;
    bool valid_value; //Zero-remainder constraint foutput_pixels_to_compute
...
private:
   ...
   unsigned long long output_pixels_to_compute;  //This variable has the number of output pixels that the simulator must calculate before finishing the execution
