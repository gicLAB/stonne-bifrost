...
## STONNE Parameters to use the simulator. These parameters will have to be changed accordingly to the required simulation
tiles_path = 'tiles/128_mses'
sparsity_ratio = 0.0
simulation_engine='simulation_files/128_mses_accbuffer'
...
class BertSelfAttention(nn.Module):
    ...
    def forward(
        ...
        print('key_layer.transpose shape')
...
class BertSelfOutput(nn.Module):
    def __init__(self, config):
        super().__init__()
        print(str(config.hidden_size)+'x'+str(config.hidden_size))
...
class BertOutput(nn.Module):
    def __init__(self, config):
        super().__init__()
        print(str(config.intermediate_size)+'x'+str(config.hidden_size))
